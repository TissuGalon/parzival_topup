                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($query)) {
                                                ...
                                                <tr id="<?php echo $no; ?>">
                                                    ...
                                                    <td id=""><?php echo $row['id_product'] ?></td>
                                                    <td id=""><?php echo $row['nama_product'] ?></td>
                                                    <td id=""><?php echo $row['tipe'] ?></td>
                                                    <td id=""><?php echo $row['jenis'] ?></td>
                                                    <td id=""><?php echo $row['gambar'] ?></td>
                                                    <td id=""><?php echo $row['status'] ?></td>                                     
                                                    <td>
